...
public class TableProvider extends ContentProvider{
    ...
    static {
        ...
        tblProjectionMap.put(Tables.FLAG, Tables.FLAG);
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		// 插入数据，返回行ID
		long rowId = db.insert(DBHelper.TABLES_TableTbl,Tables.NUM, values);
		// 如果插入成功返回uri
        if (rowId > 0) {
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		 ...
		 SQLiteQueryBuilder qb = new SQLiteQueryBuilder();
	        ...
	        // 查询所有
	        case TABLES:
	            qb.setTables(DBHelper.TABLES_TableTbl);
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		// 获得数据库实例
		SQLiteDatabase db = dbHelper.getWritableDatabase();
		db.delete(DBHelper.TABLES_TableTbl, null, null);
		return 0;
	}
	@Override
